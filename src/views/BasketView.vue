        ...
        <div class="flex items-start my-8 flex-wrap justify-between">
            ...
            <div class="border-2 rounded-md p-8">
                ...
                <div v-if="deliver" class="flex flex-col items-start">    
                    ...
                    <br>
                    <input type="text" placeholder="Введите адрес доставки" class="p-2 outline-none rounded-lg border-2">
                </div>
                
                
                <button class="my-8 bg-blue-600 text-white font-bold p-4 rounded-md text-xl">Оформить покупку</button>
