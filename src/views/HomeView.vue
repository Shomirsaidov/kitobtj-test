<template>
  ...
  <div class="category p-4 my-2 lg:px-16">
    ...
    <div class="flex items-stretch space-x-4 overflow-x-auto slider" style="scroll-snap-type: x mandatory;">
      ...
      <div class="card border-2 p-4 rounded-lg hover:shadow-xl flex flex-col justify-between" v-for="(book,index) in booksBeforeProduction"
      :key="index" style="max-width: 170px;" @click="navigate('/book/' + book.name)">
        <div>
  ...
  <div class="category p-4 my-2 lg:px-16">
    ...
    <div class="flex items-stretch space-x-4 overflow-x-auto slider" style="scroll-snap-type: x mandatory;">
      ...
      <div class="card border-2 p-4 rounded-lg hover:shadow-xl flex flex-col justify-between" v-for="(book,index) in newBooks"
...
export default {
  ...
  async mounted() {
    await axios.get('https://vercel-sql.vercel.app/show/7')
      .then(data => {
        console.log(data)
